...
nighttime = np.genfromtxt('Nighttime data 2004.csv', dtype=float, usecols=(0,1), delimiter=',', converters={a: read_int for a in range(366)})
...
#print(nighttime_times[months_len_2004[7],1])
