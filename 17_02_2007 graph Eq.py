...
vlf_amp_month_NWC, vlf_phase_month_NWC = raw(months[1], months_len_day[1], 7, 0, 1)
vlf_amp_month_JJI, vlf_phase_month_JJI = raw(months[1], months_len_day[1], 7, 4, 5) 
vlf_amp_month_JJY, vlf_phase_month_JJY = raw(months[1], months_len_day[1], 7, 6, 7) 

#----------------Main code (Average)------------------------

# NWC (0,1) JJI (4,5) JJY(6,7)
vlf_amp_avg_NWC, vlf_phase_avg_NWC = average(months[1], months_len_day[1], months[0], months_len_day[0], 6, 0, 1)
vlf_amp_avg_JJI, vlf_phase_avg_JJI = average(months[1], months_len_day[1], months[0], months_len_day[0], 6, 4, 5) 
vlf_amp_avg_JJY, vlf_phase_avg_JJY = average(months[1], months_len_day[1], months[0], months_len_day[0], 6, 6, 7)  
