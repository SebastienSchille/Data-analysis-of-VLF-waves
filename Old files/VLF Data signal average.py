...
ax.set_title('Amplitude NWC-PTK')
ax.set_xticks(list(range(0,4500,720)))
...
ax.set_title('Amplitude JJI-PTK')
ax.set_xticks(list(range(0,4500,720)))
ax.set_xticklabels(['0','4','8','12','16','20','24'])
plt.xlabel('Time UTC')
plt.ylabel('dB')
...
ax.set_title('Amplitude JJY-PTK')
ax.set_xticks(list(range(0,4500,720)))
ax.set_xticklabels(['0','4','8','12','16','20','24'])
plt.xlabel('Time UTC')
plt.ylabel('dB')
